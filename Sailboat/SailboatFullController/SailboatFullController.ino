...
const unsigned int DEBUG_SERIAL_BAUDRATE = 115200;
...
const unsigned long GPS_GOAL_LONGITUDE = 45500000;		// 45°30’00″
...
void loop()
{
	...
	if (gps.location.age() < GPS_VALID_DATA_LIMIT_AGE)
	{
		...
		rudder_controllerInferenceEngine(goalAlignment - bearing, &rudderActuationValue);
		sail_controllerInferenceEngine(abs(roll), goalAlignment - bearing, windAlignment, &sailActuationValue);
